...
if (to_admin_panel) { to_admin_panel.addEventListener("click", () => location.href = 'administrator/site_panel.php'); }
if (to_logout) { to_logout.addEventListener("click", () => location.href = 'administrator/logout.php'); }
